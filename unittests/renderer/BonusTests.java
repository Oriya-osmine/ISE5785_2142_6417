...
class LivingRoomTests {
    /** Default constructor to satisfy JavaDoc generator */
    LivingRoomTests() { /* to satisfy JavaDoc generator */ }
    ...
    Color  baseTEbale= new Color(101, 67, 33);
    ...
    void livingRoomScene() {
        ...
        scene.geometries
                .add(
                        ...
                        new Polygon(
                                new Point(-200, -300, -200),  // Bottom-left
                                new Point(-115, -300, -200),   // Bottom-right
                                new Point(-115, 300, -200),    // Top-right
                                new Point(-200, 300, -200)    // Top-left
                        ).setEmission(walls).setMaterial(wall),

// Back wall - right section
                        new Polygon(
                                new Point(270, -300, -200),   // Bottom-left
                                new Point(350, -300, -200),   // Bottom-right
                                new Point(350, 300, -200),    // Top-right
                                new Point(270, 300, -200)     // Top-left
                        ).setEmission(walls).setMaterial(wall),

// Back wall - top section
                        new Polygon(
                                new Point(-115, 200, -200),     // Bottom-left
                                new Point(270, 200, -200),     // Bottom-right
                                new Point(270, 300, -200),    // Top-right
                                new Point(-115, 300, -200)     // Top-left
                        ).setEmission(walls).setMaterial(wall),

// Back wall - bottom section
                        new Polygon(
                                new Point(-115, 50, -200),   // Bottom-left
                                new Point(270, 50, -200),   // Bottom-right
                                new Point(270, -42, -200),    // Top-right
                                new Point(-115, -42, -200)     // Top-left
                        ).setEmission(walls).setMaterial(wall),

                        new Polygon(
                                new Point(-150, -300, 200),  // Bottom-right
                                new Point(-200, -300, 200),  // Bottom-left
                                new Point(-200, 300, 200),   // Top-left
                                new Point(-150, 300, 200)    // Top-right
                        ).setEmission(walls).setMaterial(wall),
                        new Polygon(
                                new Point(-150, -300, 150),  // Bottom-left
                                new Point(-150, -300, 200),  // Bottom-right
                                new Point(-150, 300, 200),   // Top-right
                                new Point(-150, 300, 150)    // Top-left   // Top-left
                        ).setEmission(walls).setMaterial(wall),


                        // Ceiling with a smooth, clean color
                        new Polygon(
                                new Point(-200, 300, -200),  // Back-left
                                new Point(350, 300, -200),   // Back-right
                                new Point(350, 300, 850),    // Front-right
                                new Point(-200, 300, 850)    // Front-left
        ...
        scene.geometries
                .add(
                        ...
                        new Sphere(new Point(70, 260, 100), 8)
                                .setEmission(new Color(yellow))  // Warm light color
                        ...
                        //Sky
                        new Polygon(
                                new Point(-300, 0, -271),   // Bottom-left
                                new Point(400, 0, -271),    // Bottom-right
                                new Point(400, 300, -271),   // Top-right
                                new Point(-300, 300, -271)   // Top-left
                        )
        ...
        scene.geometries
                .add(
                        ...
                        new Polygon(
                                new Point(30, 16, 300),    // Bottom-left
                                new Point(255, 16, 300),     // Bottom-right
                                new Point(255, 20, 300),      // Top-right
                                new Point(30, 20, 300)      // Top-left
                        ).setEmission(baseTEbale) // Brown color for wood
                                .setMaterial(new Material().setKD(0.8).setKS(0.3).setShininess(30)),
                        new Triangle(
                                new Point(50, 17, 300.1),    // Base left
                                new Point(70, 17, 300.1),    // Base right
                                new Point(60, 20, 300.1)     // Top peak
                        ).setEmission(new Color(80, 40, 10)) // Darker brown
                                .setMaterial(new Material().setKD(0.7).setKS(0.4).setShininess(40)),
                        new Triangle(
                                new Point(100, 17, 300.1),   // Base left
                                new Point(120, 17, 300.1),   // Base right
                                new Point(110, 20, 300.1)    // Top peak
                        ).setEmission(new Color(80, 40, 10)) // Darker brown
                                .setMaterial(new Material().setKD(0.7).setKS(0.4).setShininess(40)),
                        new Triangle(
                                new Point(150, 17, 300.1),   // Base left
                                new Point(170, 17, 300.1),   // Base right
                                new Point(160, 20, 300.1)    // Top peak
                        ).setEmission(new Color(80, 40, 10)) // Darker brown
                                .setMaterial(new Material().setKD(0.7).setKS(0.4).setShininess(40)),
                        new Triangle(
                                new Point(200, 17, 300.1),   // Base left
                                new Point(220, 17, 300.1),   // Base right
                                new Point(210, 20, 300.1)    // Top peak
                        ).setEmission(new Color(80, 40, 10)) // Darker brown
                                .setMaterial(new Material().setKD(0.7).setKS(0.4).setShininess(40)),
                        //leg
